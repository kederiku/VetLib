 ...
 * mais était INATTEIGNABLE, faute d'un provider et d'un interrupteur.
 * Ce composant est l'interrupteur qui manquait. Il s'appuie sur
 * next-themes (ThemeProvider monté dans providers.tsx) : setTheme
