/**
 * Composant RadioGroup (preset shadcn/ui, primitive Base UI).
 *
 * Groupe de boutons radio accessibles : un seul choix parmi plusieurs
 * (l'espece d'un animal, l'animal d'un rendez-vous). Composant CONTROLE
 * uniquement via value/onValueChange — pas de value lisible par le
 * register() de react-hook-form : dans un formulaire, le brancher via
 * <Controller> (meme logique que la Checkbox du profil).
 */
"use client"
