/**
 * Composant Tabs (preset shadcn/ui, variante Base UI).
 *
 * Onglets accessibles (navigation aux flèches, ARIA) construits sur la
 * primitive Tabs de Base UI. Utilisés par la page « Mes rendez-vous »
 * pour séparer « À venir » et « Passés » : deux intentions distinctes
 * (« qu'est-ce qui m'attend ? » et « quand suis-je venu ? ») dont la
 * seconde grandit indéfiniment, alors que la première tient en trois
 * lignes.
 */
"use client"
