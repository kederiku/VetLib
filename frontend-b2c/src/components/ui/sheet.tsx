/**
 * Composant Sheet (preset shadcn/ui, variante Base UI).
 *
 * Panneau coulissant depuis un bord de l'écran, construit sur la
 * primitive Dialog de Base UI (même accessibilité : focus piégé, Échap,
 * overlay). Utilisé ici par la Sidebar en affichage mobile : sous
 * 768 px, la navigation latérale devient un tiroir que l'on ouvre
 * depuis le bouton du header.
 */
"use client"
