/**
 * Composant ToggleGroup (preset shadcn/ui, primitives Base UI).
 *
 * Groupe de Toggle : par defaut UN seul element presse a la fois
 * (selection simple — le cas de la grille d'horaires du wizard), ou
 * plusieurs avec toggleMultiple. onValueChange recoit le TABLEAU des
 * valeurs pressees (meme en selection simple : [valeur] ou []). Le
 * Context partage variant/size du groupe avec chaque item.
 */
"use client"
