/**
 * Composant Tooltip (preset shadcn/ui, variante Base UI).
 *
 * Info-bulle au survol/focus. Tiré par la Sidebar : quand elle est
 * repliée en rail d'icônes, chaque entrée affiche son libellé en
 * tooltip -- sans quoi le rail serait une colonne de pictogrammes
 * indéchiffrables. Le TooltipProvider du projet règle le délai à 0 :
 * identifier une icône de navigation doit être instantané.
 */
"use client"
