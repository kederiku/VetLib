/**
 * Composant DropdownMenu (preset shadcn/ui, variante Base UI).
 *
 * Menu contextuel accessible (clavier, ARIA) construit sur la primitive
 * Menu de Base UI. Deux usages dans le portail propriétaires : le menu
 * du compte dans le header (identité, lien vers la fiche, déconnexion)
 * et le sélecteur de thème. La variante "destructive" d'un item signale
 * les actions à conséquence, comme la déconnexion.
 *
 * PIÈGE Base UI : un DropdownMenuLabel est un GroupLabel, il LÈVE une
 * erreur s'il n'est pas enveloppé dans un DropdownMenuGroup.
 */
"use client"
