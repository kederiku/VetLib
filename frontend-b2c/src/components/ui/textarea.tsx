/**
 * Composant Textarea (preset shadcn/ui).
 *
 * Zone de texte multi-lignes stylee comme l'Input du design system.
 * field-sizing-content : la hauteur suit le contenu saisi (CSS moderne,
 * pas de JavaScript de redimensionnement). Sert au motif libre du
 * wizard de prise de rendez-vous.
 */
