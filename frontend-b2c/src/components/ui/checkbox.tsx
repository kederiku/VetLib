/**
 * Composant Checkbox (preset shadcn/ui, variante Base UI).
 *
 * Case a cocher accessible construite sur la primitive Base UI : le vrai
 * <input> est masque, la case visible est un bouton stylise et l'icone
 * CheckIcon n'apparait que via l'Indicator quand la case est cochee.
 * ATTENTION : c'est un composant CONTROLE (props checked/onCheckedChange,
 * pas de value lisible par register) — avec react-hook-form, il faut donc
 * passer par <Controller> ou useController. Utilise ici pour les
 * preferences de notification (rappels email / SMS) de la fiche
 * proprietaire.
 */
"use client"
