/**
 * Composant Toggle (preset shadcn/ui, primitive Base UI).
 *
 * Bouton a deux etats (presse / relache) avec ses variantes visuelles
 * CVA. Rarement utilise seul ici : il sert surtout de brique au
 * ToggleGroup (grille des horaires du wizard), qui reutilise ses
 * toggleVariants.
 */
"use client"
