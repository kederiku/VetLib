/**
 * Composant AlertDialog (preset shadcn/ui, primitive Base UI).
 *
 * Variante du Dialog dediee aux CONFIRMATIONS d'actions engageantes
 * (supprimer un animal, annuler un rendez-vous) : pas de croix de
 * fermeture ni de fermeture au clic exterieur, l'utilisateur doit
 * choisir explicitement entre AlertDialogCancel et AlertDialogAction.
 * role="alertdialog" : les lecteurs d'ecran interrompent pour l'annoncer.
 */
"use client"
