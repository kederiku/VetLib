/**
 * Bouton de déconnexion du portail propriétaires.
 *
 ...
 * protégée et purger le cache de session — dans CET ordre, voir le
 * commentaire du onSuccess.
 */
"use client";
  ...
  const logoutMutation = useOwnerLogout<ApiError>({
    mutation: {
      onSuccess: () => {
        ...
        queryClient.removeQueries({ queryKey: getGetCurrentOwnerQueryKey() });
      },
    },
  });
