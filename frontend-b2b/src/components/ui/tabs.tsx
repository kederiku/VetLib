 ...
 *
 * Onglets accessibles (navigation flèches, ARIA) construits sur la
 * primitive Tabs de Base UI. Utilisés par la page Réglages : chaque
 * TabsContent monte son contenu à l'affichage de l'onglet, les queries
 * d'un onglet ne partent donc qu'à sa première ouverture.
 */
"use client"
