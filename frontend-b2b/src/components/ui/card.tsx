/**
 * Composant Card (preset shadcn/ui).
 *
 * Conteneur visuel de base du portail : un panneau arrondi sur fond
 * `bg-card` avec une ombre douce. Se compose en sous-parties nommees
 ...
 * formulaires d'authentification et a la carte profil du tableau de bord.
 */
