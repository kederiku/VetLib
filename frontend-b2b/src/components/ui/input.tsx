/**
 * Composant Input (preset shadcn/ui, variante Base UI).
 *
 * Champ de saisie stylé au-dessus de la primitive accessible de Base UI.
 * Les classes aria-invalid:* colorent automatiquement le champ en rouge
 * quand un formulaire (react-hook-form) le marque invalide : c'est le
 * pont visuel entre la validation zod et l'utilisateur.
 */
