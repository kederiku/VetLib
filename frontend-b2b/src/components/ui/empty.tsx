/**
 * Composant Empty (preset shadcn/ui).
 *
 * État vide standardisé (icône + titre + description + action) : période
 * d'agenda sans rendez-vous, aucun praticien sélectionné, accès refusé.
 * Purement présentationnel — de simples <div> composables.
 */
