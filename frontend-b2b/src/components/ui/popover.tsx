/**
 * Composant Popover (preset shadcn/ui, variante Base UI).
 *
 * Panneau flottant ancré à un déclencheur (positionné par Base UI,
 * rendu en portal au-dessus du reste). Utilisé pour ouvrir le Calendar
 * des champs de date (nouveau rendez-vous, absences).
 */
"use client"
