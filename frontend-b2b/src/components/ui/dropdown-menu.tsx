 ...
 * Menu de Base UI. Utilisé pour les actions d'un rendez-vous dans
 * l'agenda (Confirmer / Terminer / Annuler). La variante "destructive"
 * d'un item signale les actions à conséquence (annulation).
 */
"use client"
