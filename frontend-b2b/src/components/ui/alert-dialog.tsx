/**
 * Composant AlertDialog (preset shadcn/ui, variante Base UI).
 *
 * Variante du Dialog pour les CONFIRMATIONS d'actions à conséquence
 * (annuler un rendez-vous, supprimer une absence) : pas de fermeture au
 * clic sur l'overlay, l'utilisateur doit choisir explicitement.
 * Particularité de ce preset : AlertDialogAction est un simple Button
 * (il ne ferme PAS le dialog), l'appelant garde la main pour attendre
 * sa mutation avant de fermer ; AlertDialogCancel, lui, ferme.
 */
"use client"
