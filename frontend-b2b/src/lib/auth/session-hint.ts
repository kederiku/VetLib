/**
 * Indice de session locale ("session hint") du portail B2B.
 *
...
/** Clé localStorage : préfixée vetolib_b2b pour ne pas entrer en
 * collision avec le portail B2C si les deux tournent sur le même hôte. */
const SESSION_HINT_KEY = "vetolib_b2b_session_hint";
