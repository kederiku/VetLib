...
Deux familles : le STAFF de clinique (B2B — RegisterClinic, AuthenticateUser,
RefreshToken, GetCurrentUser) et les PROPRIÉTAIRES d'animaux (B2C —
RegisterOwner, AuthenticateOwner, RefreshOwnerToken, GetCurrentOwner,
UpdateOwnerProfile). Espaces de comptes et de sessions indépendants.
"""
