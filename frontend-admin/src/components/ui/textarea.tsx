 ...
 *
 * Zone de texte multi-lignes : un simple <textarea> natif stylé (aucune
 * primitive nécessaire), compatible register() de react-hook-form.
 * Utilisé pour les motifs et raisons (rendez-vous, annulation).
 */
