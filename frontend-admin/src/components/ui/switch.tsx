/**
 * Composant Switch (preset shadcn/ui, variante Base UI).
 *
 * Interrupteur on/off accessible (rôle switch ARIA). Composant CONTRÔLÉ
 * (checked/onCheckedChange) : dans les formulaires react-hook-form, il
 * passe par <Controller>, comme la Checkbox du portail B2C. Utilisé pour
 * "actif/inactif" (types, praticiens) et "jour ouvert" (horaires).
 */
"use client"
