/**
 * AuthGuard : garde des pages réservées aux administrateurs connectés.
 *
 ...
 * commodité d'expérience utilisateur, pas une barrière de sécurité -- et
 * dans CET espace, il faut se le rappeler : le cookie n'est joint qu'aux
 * routes /api/v1/admin, le claim kind="platform" est exigé sans tolérance,
 * et le compte est relu en base à chaque requête. Rien de tout cela ne se
 * joue ici.
 */
"use client";
